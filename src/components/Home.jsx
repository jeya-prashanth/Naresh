...
const Home = () => {
  ...
  return (
    <section
      id="home"
      className="min-h-screen bg-gradient-to-br from-blue-50 to-white pt-16"
    >
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          >
            <div className="relative">
              <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl hover:shadow-4xl hover:scale-110 transition-all duration-500 border-8 border-white bg-gradient-to-br from-blue-100 to-blue-200">
                <img
                  src={profile1}
                  alt="Profile"
          ...
          <div className="lg:w-1/2 text-center lg:text-left mb-0 mt-8 lg:mt-0">
            <motion.h1
              ...
              className="text-4xl md:text-5xl lg:text-[80px] font-bold text-gray-500 mb-6 leading-tight"
            >
              <motion.span
                initial={{ x: 100, opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
              ...
              <motion.span
                ...
                className="text-[#1a0055] font-bold"
              >
                BN Naresh
              </motion.span>
            </motion.h1>
            <motion.h2
              ...
              className="text-xl md:text-2xl text-[#1a0055] mb-4 font-medium"
            >
              CAD Technician
            </motion.h2>
            <motion.p
            ...
            >
              Passionate about creating precise technical drawings and
              innovative designs using cutting-edge CAD software. Bringing ideas
              to life through detailed engineering solutions.
            </motion.p>
